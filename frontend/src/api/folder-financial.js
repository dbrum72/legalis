...
export const createFolderBilling = (folderId, payload) => apiClient.post(`${basePath(folderId)}/billing`, payload)
...
export const updateTimeEntry = (folderId, id, payload) => apiClient.patch(`${basePath(folderId)}/time-entries/${id}`, payload)
...
export const updateExpense = (folderId, id, payload) => apiClient.patch(`${basePath(folderId)}/expenses/${id}`, payload)
